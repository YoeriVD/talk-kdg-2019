...
{
    public static readonly WebApplication.Controllers.HomeController Home = new WebApplication.Controllers.R4MVC_HomeController();
...
public static partial class Links
{
    ...
    public static partial class lib
    {
        ...
        public static partial class bootstrap
        {
            ...
            public static partial class css
            {
                public const string UrlPath = "~/lib/bootstrap/css";
                public static string Url() => R4MvcHelpers.ProcessVirtualPath(UrlPath);
                public static string Url(string fileName) => R4MvcHelpers.ProcessVirtualPath(UrlPath + "/" + fileName);
            ...
            public static partial class js
            {
                public const string UrlPath = "~/lib/bootstrap/js";
                public static string Url() => R4MvcHelpers.ProcessVirtualPath(UrlPath);
                public static string Url(string fileName) => R4MvcHelpers.ProcessVirtualPath(UrlPath + "/" + fileName);
